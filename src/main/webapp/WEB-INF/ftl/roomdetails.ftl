                        ...
                        <td>
                                    <#if mr.status==0>
                                        <input type="radio" id="status" name="status" checked="checked"
                                               value="0"/><label for="status">可用</label>
                                        <input type="radio" id="status" value="1" name="status"/><label for="status" value="1">已被占用</label>
                                    <#else>
                                        <input type="radio" id="status" name="status" value="0"/><label
                                            for="status">可用</label>
                                    <input type="radio" id="status" value="1" name="status" checked="checked"/><label for="status"
                                                                                                            value="1">已被占用</label>
                                    </#if>
                        </td>
                    </tr>
