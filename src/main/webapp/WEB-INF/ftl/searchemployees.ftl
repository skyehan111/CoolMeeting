                                    ...
                                    <#if employee??>
                                        <#if employee.status==1>
                                            <input type="radio" id="status" name="status" value="1"
                                                   checked="checked"/><label>有效账户</label>
                                            <input type="radio" id="status" name="status" value="0"/><label>待审批</label>
                                            <input type="radio" id="status" name="status" value="2"/><label>无效账户</label>
                                        </#if>
                                        <#if employee.status==0>
                                            <input type="radio" id="status" name="status" value="1"/><label>有效账户</label>
                                        ...
                                        <#if employee.status==2>
                                            ...
                                            <input type="radio" id="status" name="status" value="2"
                                                    checked="checked"/><label>无效账户</label>
                                        </#if>
                                    <#else>
                                        <input type="radio" id="status" name="status" value="1"
                                               checked="checked"/><label>有效账户</label>
        ...
        <div>
            ...
            <div class="pager-header">
                ...
                <div class="header-nav">
                    <#if page!=1>
                        <a href="/admin/searchemployees?status=${employee.status}&page=1">首页</a>
                        <a href="/admin/searchemployees?status=${employee.status}&page=${page-1}">上一页</a>
                    </#if>
                    <#if page!=pagenum>
                        <a href="/admin/searchemployees?status=${employee.status}&page=${page+1}">下一页</a>
                        <a href="/admin/searchemployees?status=${employee.status}&page=${pagenum}">尾页</a>
                    </#if>
                </div>
            </div>
        </div>
